...
const DEFAULT_NAV_ITEMS: NavItemConfig[] = [
  ...
  { key: 'my-menus', href: '/dashboard/menus', label: 'My Menus', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" /></svg> },
...
const NAV_KEYS: Record<string, string> = {
  ...
  'My Menus': 'web.menus', 'Import & Scan': 'web.import', 'Speak a Recipe': 'web.speak',
};
