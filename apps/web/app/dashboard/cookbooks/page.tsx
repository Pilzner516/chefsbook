      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-cb-card border border-cb-border text-cb-text px-5 py-2.5 rounded-input text-sm font-semibold hover:border-cb-primary/50 transition-colors flex items-center gap-2"
          >
