    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div data-onboard="week-nav" className="flex items-center gap-2 bg-cb-card border border-cb-border rounded-input px-1">
      ...
      {loading ? (
        ...
        <div data-onboard="add-meal" className="space-y-3">
          {/* Row 1: Mon–Fri */}
