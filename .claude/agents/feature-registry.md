...
| 215-site compatibility crawl | LIVE | packages/ai/src/siteList.ts, scripts/test-site-compatibility.mjs, scripts/generate-compat-report.mjs, docs/SITE-COMPATIBILITY-REPORT-2026-04-15.md | 143, 145 | 218 sites across 18 regions × 18 languages with region/language/cuisine metadata; crawl script runs on RPi5 at 8s/site with UA rotation + homepage discovery; populates import_site_tracker with rating 1-5; compat report grouped by region + language |
