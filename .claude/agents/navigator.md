...
2026-05-02 — FloatingTabBar exclusion list expanded: /speak and /cook-menu/[id] now hide the tab bar. Wizard/flow screens with their own bottom navigation (Continue buttons, step nav) should not show the tab bar. Audited all root Stack screens; others (recipe/[id], recipe/new, plans, chef/[id], cookbook/[id], share/[token]) use proper safe-area padding and don't need exclusion.
